...
import defaultFeatures from './../RichEditor/lib/default-features';
...
class PlainMarkdownEditor extends Component {
  ...
  render() {
    return (
      <div className="opuscapita_plain-markdown-editor">
        {this.renderAutocompleteItemsList()}
        <div className="opuscapita_plain-markdown-editor__toolbar">
          <RichEditorToolbar
